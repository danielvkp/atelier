    ...
    <v-container>
        <v-card>
            <v-toolbar flat color="blue" class="white--text">
                ...
                <v-toolbar-title>
                    <h3 class="font-weight-light">Blog</h3>
                </v-toolbar-title>
            </v-toolbar>
            ...
            <v-card-text>
                ...
                <v-row dense class="mt-0">
                    ...
                    <v-col cols="12" md="4">
                        <v-btn to="/guardar-blog" class="mt-1 white--text" color="blue">
                            nuevo
                        </v-btn>
                    </v-col>
                </v-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            delete_blog() {
                blog_service.delete_blog(this.item.id).then(res => {
            ...
            get_blogs() {
                blog_service.get_blogs().then(res => {
                    this.items = res.data
                }, res => {
