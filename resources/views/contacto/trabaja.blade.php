@extends('base')
@section('title', 'Trabaja con nosotros | Centro de Psicología equilibrio y mente')
@section('main')

<div class="bg-alter w-full py-[120px] lg:py-[140px]">
    <div class="container">
        <h1 class="text-3xl font-bold uppercase text-white text-center">
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="w-full order-1 lg:order-2  lg:w-1/3 mx-auto p-2">
                    ...
                    <div class="">
                        ...
                        <form id="demo-form" class="mt-4" enctype="multipart/form-data" action="{{route('cv')}}" method="post">
                            @csrf
                            <x-honeypot />
                            <input required type="text" value="{{old('nombre')}}" name="nombre"
                              class="rounded-lg border border-gray-400 block w-full min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6" placeholder="Nombre y Apellidos">
                            <br>
                            ...
                            <input accept="application/pdf" type="file" value="" name="cv_file"
                              class="rounded-lg border border-gray-400 block w-full min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6" placeholder="">
                            <br>
